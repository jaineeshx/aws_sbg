...
const LINKS = [
  ...
  { heading: "Community", items: [
    { l: "WhatsApp Community", h: "#", ext: true },
    { l: "Meetup", h: "https://www.meetup.com/aws-sbg-at-rv-university/", ext: true, Icon: SiMeetup },
    { l: "LinkedIn Page", h: "#", ext: true },
...
const SOCIALS = [
  ...
  { Icon: SiMeetup,    label: "Meetup",    href: "https://www.meetup.com/aws-sbg-at-rv-university/" },
];
    ...
    <footer style={{ borderTop: "1px solid rgba(255,255,255,0.06)", background: "rgba(0,0,0,0.4)" }}>
      <div style={{ ...W, paddingTop: 80, paddingBottom: 60 }}>
          ...
          <div id="footer-grid" style={{ display: "contents" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                <div style={{ width: 36, height: 36, borderRadius: 8, overflow: "hidden", border: "1px solid rgba(255,255,255,0.1)" }}>
                  <img src="/logo-sbg.jpg" alt="AWS SBG Logo" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
                </div>
                <div>
                ...
                <ul style={{ display: "flex", flexDirection: "column", gap: 12, listStyle: "none" }}>
                  {col.items.map((item) => {
                    ...
                    return (
                      ...
                      >
                        {IconComp && <span style={{ display: "flex", alignItems: "center", marginRight: 4 }}><IconComp size={14} /></span>}
                        {item.l}
        ...
        <div style={{
          ...
          <p className="mono" style={{ fontSize: 11, color: "rgba(255,255,255,0.2)", marginLeft: "auto" }}>
